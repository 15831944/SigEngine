...
CSigGeoProj::CSigGeoProj()
{
  ...
  mp_asConvBuffer.AddStringTail(""); // String 0, projection CONVERS par défaut

  _InitCurrentSysGeo(); // Ajout à la base de donnée tous les systèmes géodésiques 'connus'
}
...
void CSigGeoProj::_InitCurrentSysGeo(void)
{
  ...
  _AddCurrentSysGeo(NULL, "Non-Terrestre (millimètres)", 0, 5);
  _AddCurrentSysGeo(NULL, "Non-Terrestre (centimètres)", 0, 6);
  _AddCurrentSysGeo(NULL, "Non-Terrestre (mètres)", 0, 7);
  _AddCurrentSysGeo(NULL, "Non-Terrestre (kilomètres)", 0, 1);

  mp_nIndexFam = mp_asStringBuffer.AddStringTail("Projections du Monde");

  _AddCurrentSysGeo(NULL, "Behrmann Cylindrique Surfaces Égales", 2, 62, 7, 0, 30);
  _AddCurrentSysGeo(NULL, "Eckert IV (Surfaces Égales)", 14, 62, 7, 0);
  _AddCurrentSysGeo(NULL, "Eckert VI (Surfaces Égales)", 15, 62, 7, 0);
  ...
  _AddCurrentSysGeo(NULL, "Mollweide (Surfaces Égales)", 13, 62, 7, 0);
  _AddCurrentSysGeo(NULL, "Robinson", 12, 62, 7, 0);
  _AddCurrentSysGeo(NULL, "Sinusoïdale (Surfaces Égales)", 16, 62, 7, 0);

  mp_nIndexFam = mp_asStringBuffer.AddStringTail("Projections d'une Hémisphère");

  _AddCurrentSysGeo(NULL, "Azimuthale Équidistante (Pôle Nord)", 5, 62, 7, 0, 90, 90);
  _AddCurrentSysGeo(NULL, "Azimuthale Équidistante (Pôle Sud)", 5, 62, 7, 0, -90, 90);
  _AddCurrentSysGeo(NULL, "Lambert Azimuthale Surfaces Égales (Pôle Nord)", 4, 62, 7, 0, 90, 90);
  _AddCurrentSysGeo(NULL, "Lambert Azimuthale Surfaces Égales (Pôle Sud)", 4, 62, 7, 0, -90, 90);

  mp_nIndexFam = mp_asStringBuffer.AddStringTail("Projections Régionales Conformes");
  ...
  _AddCurrentSysGeo(NULL, "Projection Conforme (Amérique Centrale)", 10, 0, 0, -85.5);
  ...
  _AddCurrentSysGeo(NULL, "Projection Conforme (Amérique du Nord)", 3, 62, 7, -96, 23, 20, 60, 0, 0);
  _AddCurrentSysGeo(NULL, "Projection Conforme (Amérique du Sud)", 10, 0, 0, -60);
  _AddCurrentSysGeo(NULL, "Projection Conforme (États Unis)", 3, 62, 7, -96, 23, 33, 45, 0, 0);

  mp_nIndexFam = mp_asStringBuffer.AddStringTail("Projections Régionales Surfaces Égales");

  _AddCurrentSysGeo(NULL, "Projection Surfaces Égales (Afrique)", 2, 0, 0, 20, 0);
  _AddCurrentSysGeo(NULL, "Projection Surfaces Égales (Asie)", 9, 0, 0, 95, 40, 20, 60, 0, 0);
  _AddCurrentSysGeo(NULL, "Projection Surfaces Égales (Australia)", 9, 0, 0, 132.5, -10, -21.5, -33.5, 0, 0);
  _AddCurrentSysGeo(NULL, "Projection Surfaces Égales (Amérique Centrale)", 2, 0, 0, -85.5, 13);
  _AddCurrentSysGeo(NULL, "Projection Surfaces Égales (Chine)", 9, 0, 0, 110, 10, 25, 40, 0, 0);
  _AddCurrentSysGeo(NULL, "Projection Surfaces Égales (Europe)", 9, 0, 0, 25, 35, 40, 65, 0, 0);
  _AddCurrentSysGeo(NULL, "Projection Surfaces Égales (Inde)", 9, 0, 0, 78, 23, 22, 33, 0, 0);
  _AddCurrentSysGeo(NULL, "Projection Surfaces Égales (Middle East)", 9, 0, 0, 47.5, 25, 15, 35, 0, 0);
  _AddCurrentSysGeo(NULL, "Projection Surfaces Égales (Amérique du Nord)", 9, 62, 7, -96, 23, 20, 60, 0, 0);
  _AddCurrentSysGeo(NULL, "Projection Surfaces Égales (Amérique du Sud)", 14, 0, 0, -60);
  _AddCurrentSysGeo(NULL, "Projection Surfaces Égales (États Unis)", 9, 62, 7, -96, 23, 29.5, 45.5, 0, 0);
  ...
  mp_nIndexFam = mp_asStringBuffer.AddStringTail("Systèmes de Coordonnées Belges");

  _AddCurrentSysGeo(NULL, "Système National Belge (1950)" /*\\p21500"*/, 3, 110, 7, 4.367975, 90, 49.8333333333, 51.1666666667, 150000, 5400000);
  _AddCurrentSysGeo(NULL, "Système National Belge (1972)" /*\\p31300"*/, 19, 110, 7, 4.3569397222, 90, 49.8333333333, 51.1666666667, 150000.01256, 5400088.4378);
  ...
  mp_nIndexFam = mp_asStringBuffer.AddStringTail("Systèmes Français Méridien de Paris");
  ...
  mp_nIndexFam = mp_asStringBuffer.AddStringTail("Système français RGF93 Méridien de greenwich IGN");
  ...
  _AddCurrentSysGeo("UTM40S", "Réunion, RGR 92 - UTM 40 sud", 8, 104, 7, 57, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo("GSLBR", "Réunion, PDN - Gauss Laborde", 8, 9999, 4, 789.524, -626.486, -89.904, -0.6006,-76.7946, 10.5788, -32.3241, 0); //, 7, 55.53333333333, -21.11666666667, 1, 160000, 50000);
  ...
  _AddCurrentSysGeo(NULL, "Nouvelle Calédonie, Ouvéa WGS84 - UTM 58 sud", 8, 104, 7, 165, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "Nouvelle Calédonie, Grande Terre IGN72 - UTM 58 sud", 8, 9999, 4, 97.295, -263.237, 310.866, 1.599931, -0.838952, -3.141180, 13.325864, 0); //, 7, 165, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "Nouvelle Calédonie, Maré IGN53 - UTM 58 sud", 8, 9999, 4, -533.321, 238.077, -224.713, -2.381004, 7.580876, 2.346668, -124.243204, 0); //, 7, 165, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "Nouvelle Calédonie, Lifou IGN56 - UTM 58 sud", 8, 9999, 4, 137.098, 131.678, 91.473, 1.943943, 11.599469, 4.331745, -7.480528, 0); //, 7, 165, 0, 0.9996, 500000, 10000000 );
  ...
  mp_nIndexFam = mp_asStringBuffer.AddStringTail("Systèmes Français MapInfo <= 3");
  ...
  mp_nIndexFam = mp_asStringBuffer.AddStringTail("Stéréographique Polaire Universelle (UPS)");
  ...
  _AddCurrentSysGeo(NULL, "UTM Zone 18, Hémisphère Sud" /* (Corrego Alegre)"*/, 8, 24, 7, -75, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 19, Hémisphère Nord" /* (Corrego Alegre)"*/, 8, 24, 7, -69, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 19, Hémisphère Sud" /* (Corrego Alegre)"*/, 8, 24, 7, -69, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 20, Hémisphère Nord" /* (Corrego Alegre)"*/, 8, 24, 7, -63, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 20, Hémisphère Sud" /* (Corrego Alegre)"*/, 8, 24, 7, -63, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 21, Hémisphère Nord" /* (Corrego Alegre)"*/, 8, 24, 7, -57, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 21, Hémisphère Sud" /* (Corrego Alegre)"*/, 8, 24, 7, -57, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 22, Hémisphère Nord" /* (Corrego Alegre)"*/, 8, 24, 7, -51, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 22, Hémisphère Sud" /* (Corrego Alegre)"*/, 8, 24, 7, -51, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 23, Hémisphère Sud" /* (Corrego Alegre)"\\p22523"*/, 8, 24, 7, -45, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 24, Hémisphère Sud" /* (Corrego Alegre)"\\p22524"*/, 8, 24, 7, -39, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 25, Hémisphère Sud" /* (Corrego Alegre)"*/, 8, 24, 7, -33, 0, 0.9996, 500000, 10000000);
  ...
  _AddCurrentSysGeo(NULL, "UTM Zone 17, Hémisphère Nord" /* (SAD 69)"*/, 8, 92, 7, -81, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 17, Hémisphère Sud" /* (SAD 69)\\p29177"*/, 8, 92, 7, -81, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 18, Hémisphère Nord" /* (SAD 69)\\p29118"*/, 8, 92, 7, -75, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 18, Hémisphère Sud" /* (SAD 69)\\p29178"*/, 8, 92, 7, -75, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 19, Hémisphère Nord" /* (SAD 69)\\p29119"*/, 8, 92, 7, -69, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 19, Hémisphère Sud" /* (SAD 69)\\p29179"*/, 8, 92, 7, -69, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 20, Hémisphère Nord" /* (SAD 69)\\p29120"*/, 8, 92, 7, -63, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 20, Hémisphère Sud" /* (SAD 69)\\p29180"*/, 8, 92, 7, -63, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 21, Hémisphère Nord" /* (SAD 69)\\p29121"*/, 8, 92, 7, -57, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 21, Hémisphère Sud" /* (SAD 69)\\p29181"*/, 8, 92, 7, -57, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 22, Hémisphère Nord" /* (SAD 69)\\p29122"*/, 8, 92, 7, -51, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 22, Hémisphère Sud" /* (SAD 69)\\p29182"*/, 8, 92, 7, -51, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 23, Hémisphère Sud" /* (SAD 69)\\p29183"*/, 8, 92, 7, -45, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 24, Hémisphère Sud" /* (SAD 69)\\p29184"*/, 8, 92, 7, -39, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 25, Hémisphère Sud" /* (SAD 69)\\p29185"*/, 8, 92, 7, -33, 0, 0.9996, 500000, 10000000);
  ...
  _AddCurrentSysGeo(NULL, "UTM Zone 1, Hémisphère Nord" /* (WGS 84)\\p32601"*/, 8, 104, 7, -177, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 1, Hémisphère Sud" /* (WGS 84)\\p32701"*/, 8, 104, 7, -177, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 2, Hémisphère Nord" /* (WGS 84)\\p32602"*/, 8, 104, 7, -171, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 2, Hémisphère Sud" /* (WGS 84)\\p32702"*/, 8, 104, 7, -171, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 3, Hémisphère Nord" /* (WGS 84)\\p32603"*/, 8, 104, 7, -165, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 3, Hémisphère Sud" /* (WGS 84)\\p32703"*/, 8, 104, 7, -165, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 4, Hémisphère Nord" /* (WGS 84)\\p32604"*/, 8, 104, 7, -159, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 4, Hémisphère Sud" /* (WGS 84)\\p32704"*/, 8, 104, 7, -159, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 5, Hémisphère Nord" /* (WGS 84)\\p32605"*/, 8, 104, 7, -153, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 5, Hémisphère Sud" /* (WGS 84)\\p32705"*/, 8, 104, 7, -153, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 6, Hémisphère Nord" /* (WGS 84)\\p32606"*/, 8, 104, 7, -147, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 6, Hémisphère Sud" /* (WGS 84)\\p32706"*/, 8, 104, 7, -147, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 7, Hémisphère Nord" /* (WGS 84)\\p32607"*/, 8, 104, 7, -141, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 7, Hémisphère Sud" /* (WGS 84)\\p32707"*/, 8, 104, 7, -141, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 8, Hémisphère Nord" /* (WGS 84)\\p32608"*/, 8, 104, 7, -135, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 8, Hémisphère Sud" /* (WGS 84)\\p32708"*/, 8, 104, 7, -135, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 9, Hémisphère Nord" /* (WGS 84)\\p32609"*/, 8, 104, 7, -129, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 9, Hémisphère Sud" /* (WGS 84)\\p32709"*/, 8, 104, 7, -129, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 10, Hémisphère Nord" /* (WGS 84)\\p32610"*/, 8, 104, 7, -123, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 10, Hémisphère Sud" /* (WGS 84)\\p32710"*/, 8, 104, 7, -123, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 11, Hémisphère Nord" /* (WGS 84)\\p32611"*/, 8, 104, 7, -117, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 11, Hémisphère Sud" /* (WGS 84)\\p32711"*/, 8, 104, 7, -117, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 12, Hémisphère Nord" /* (WGS 84)\\p32612"*/, 8, 104, 7, -111, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 12, Hémisphère Sud" /* (WGS 84)\\p32712"*/, 8, 104, 7, -111, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 13, Hémisphère Nord" /* (WGS 84)\\p32613"*/, 8, 104, 7, -105, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 13, Hémisphère Sud" /* (WGS 84)\\p32713"*/, 8, 104, 7, -105, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 14, Hémisphère Nord" /* (WGS 84)\\p32614"*/, 8, 104, 7, -99, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 14, Hémisphère Sud" /* (WGS 84)\\p32714"*/, 8, 104, 7, -99, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 15, Hémisphère Nord" /* (WGS 84)\\p32615"*/, 8, 104, 7, -93, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 15, Hémisphère Sud" /* (WGS 84)\\p32715"*/, 8, 104, 7, -93, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 16, Hémisphère Nord" /* (WGS 84)\\p32616"*/, 8, 104, 7, -87, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 16, Hémisphère Sud" /* (WGS 84)\\p32716"*/, 8, 104, 7, -87, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 17, Hémisphère Nord" /* (WGS 84)\\p32617"*/, 8, 104, 7, -81, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 17, Hémisphère Sud" /* (WGS 84)\\p32717"*/, 8, 104, 7, -81, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 18, Hémisphère Nord" /* (WGS 84)\\p32618"*/, 8, 104, 7, -75, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 18, Hémisphère Sud" /* (WGS 84)\\p32718"*/, 8, 104, 7, -75, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 19, Hémisphère Nord" /* (WGS 84)\\p32619"*/, 8, 104, 7, -69, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 19, Hémisphère Sud" /* (WGS 84)\\p32719"*/, 8, 104, 7, -69, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo("UTM20", "UTM Zone 20, Hémisphère Nord" /* (WGS 84)\\p32620"*/, 8, 104, 7, -63, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 20, Hémisphère Sud" /* (WGS 84)\\p32720"*/, 8, 104, 7, -63, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 21, Hémisphère Nord" /* (WGS 84)\\p32621"*/, 8, 104, 7, -57, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 21, Hémisphère Sud" /* (WGS 84)\\p32721"*/, 8, 104, 7, -57, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo("UTM22", "UTM Zone 22, Hémisphère Nord" /* (WGS 84)\\p32622"*/, 8, 104, 7, -51, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 22, Hémisphère Sud" /* (WGS 84)\\p32722"*/, 8, 104, 7, -51, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 23, Hémisphère Nord" /* (WGS 84)\\p32623"*/, 8, 104, 7, -45, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 23, Hémisphère Sud" /* (WGS 84)\\p32723"*/, 8, 104, 7, -45, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 24, Hémisphère Nord" /* (WGS 84)\\p32624"*/, 8, 104, 7, -39, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 24, Hémisphère Sud" /* (WGS 84)\\p32724"*/, 8, 104, 7, -39, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 25, Hémisphère Nord" /* (WGS 84)\\p32625"*/, 8, 104, 7, -33, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 25, Hémisphère Sud" /* (WGS 84)\\p32725"*/, 8, 104, 7, -33, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 26, Hémisphère Nord" /* (WGS 84)\\p32626"*/, 8, 104, 7, -27, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 26, Hémisphère Sud" /* (WGS 84)\\p32726"*/, 8, 104, 7, -27, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 27, Hémisphère Nord" /* (WGS 84)\\p32627"*/, 8, 104, 7, -21, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 27, Hémisphère Sud" /* (WGS 84)\\p32727"*/, 8, 104, 7, -21, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo("UTM28", "UTM Zone 28, Hémisphère Nord" /* (WGS 84)\\p32628"*/, 8, 104, 7, -15, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 28, Hémisphère Sud" /* (WGS 84)\\p32728"*/, 8, 104, 7, -15, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 29, Hémisphère Nord" /* (WGS 84)\\p32629"*/, 8, 104, 7, -9, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 29, Hémisphère Sud" /* (WGS 84)\\p32729"*/, 8, 104, 7, -9, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo("UTM30", "UTM Zone 30, Hémisphère Nord" /* (WGS 84)\\p32630"*/, 8, 104, 7, -3, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 30, Hémisphère Sud" /* (WGS 84)\\p32730"*/, 8, 104, 7, -3, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo("UTM31WGS84", "UTM Zone 31, Hémisphère Nord" /* (WGS 84)\\p32631"*/, 8, 104, 7, 3, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 31, Hémisphère Sud" /* (WGS 84)\\p32731"*/, 8, 104, 7, 3, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo("UTM32WGS84", "UTM Zone 32, Hémisphère Nord" /* (WGS 84)\\p32632"*/, 8, 104, 7, 9, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 32, Hémisphère Sud" /* (WGS 84)\\p32732"*/, 8, 104, 7, 9, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo("UTM33", "UTM Zone 33, Hémisphère Nord" /* (WGS 84)\\p32633"*/, 8, 104, 7, 15, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 33, Hémisphère Sud" /* (WGS 84)\\p32733"*/, 8, 104, 7, 15, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 34, Hémisphère Nord" /* (WGS 84)\\p32634"*/, 8, 104, 7, 21, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 34, Hémisphère Sud" /* (WGS 84)\\p32734"*/, 8, 104, 7, 21, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 35, Hémisphère Nord" /* (WGS 84)\\p32635"*/, 8, 104, 7, 27, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 35, Hémisphère Sud" /* (WGS 84)\\p32735"*/, 8, 104, 7, 27, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 36, Hémisphère Nord" /* (WGS 84)\\p32636"*/, 8, 104, 7, 33, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 36, Hémisphère Sud" /* (WGS 84)\\p32736"*/, 8, 104, 7, 33, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 37, Hémisphère Nord" /* (WGS 84)\\p32637"*/, 8, 104, 7, 39, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 37, Hémisphère Sud" /* (WGS 84)\\p32737"*/, 8, 104, 7, 39, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 38, Hémisphère Nord" /* (WGS 84)\\p32638"*/, 8, 104, 7, 45, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 38, Hémisphère Sud" /* (WGS 84)\\p32738"*/, 8, 104, 7, 45, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 39, Hémisphère Nord" /* (WGS 84)\\p32639"*/, 8, 104, 7, 51, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 39, Hémisphère Sud" /* (WGS 84)\\p32739"*/, 8, 104, 7, 51, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 40, Hémisphère Nord" /* (WGS 84)\\p32640"*/, 8, 104, 7, 57, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 40, Hémisphère Sud" /* (WGS 84)\\p32740"*/, 8, 104, 7, 57, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 41, Hémisphère Nord" /* (WGS 84)\\p32641"*/, 8, 104, 7, 63, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 41, Hémisphère Sud" /* (WGS 84)\\p32741"*/, 8, 104, 7, 63, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 42, Hémisphère Nord" /* (WGS 84)\\p32642"*/, 8, 104, 7, 69, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 42, Hémisphère Sud" /* (WGS 84)\\p32742"*/, 8, 104, 7, 69, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 43, Hémisphère Nord" /* (WGS 84)\\p32643"*/, 8, 104, 7, 75, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 43, Hémisphère Sud" /* (WGS 84)\\p32743"*/, 8, 104, 7, 75, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 44, Hémisphère Nord" /* (WGS 84)\\p32644"*/, 8, 104, 7, 81, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 44, Hémisphère Sud" /* (WGS 84)\\p32744"*/, 8, 104, 7, 81, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 45, Hémisphère Nord" /* (WGS 84)\\p32645"*/, 8, 104, 7, 87, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 45, Hémisphère Sud" /* (WGS 84)\\p32745"*/, 8, 104, 7, 87, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 46, Hémisphère Nord" /* (WGS 84)\\p32646"*/, 8, 104, 7, 93, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 46, Hémisphère Sud" /* (WGS 84)\\p32746"*/, 8, 104, 7, 93, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 47, Hémisphère Nord" /* (WGS 84)\\p32647"*/, 8, 104, 7, 99, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 47, Hémisphère Sud" /* (WGS 84)\\p32747"*/, 8, 104, 7, 99, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 48, Hémisphère Nord" /* (WGS 84)\\p32648"*/, 8, 104, 7, 105, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 48, Hémisphère Sud" /* (WGS 84)\\p32748"*/, 8, 104, 7, 105, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 49, Hémisphère Nord" /* (WGS 84)\\p32649"*/, 8, 104, 7, 111, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 49, Hémisphère Sud" /* (WGS 84)\\p32749"*/, 8, 104, 7, 111, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 50, Hémisphère Nord" /* (WGS 84)\\p32650"*/, 8, 104, 7, 117, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 50, Hémisphère Sud" /* (WGS 84)\\p32750"*/, 8, 104, 7, 117, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 51, Hémisphère Nord" /* (WGS 84)\\p32651"*/, 8, 104, 7, 123, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 51, Hémisphère Sud" /* (WGS 84)\\p32751"*/, 8, 104, 7, 123, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 52, Hémisphère Nord" /* (WGS 84)\\p32652"*/, 8, 104, 7, 129, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 52, Hémisphère Sud" /* (WGS 84)\\p32752"*/, 8, 104, 7, 129, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 53, Hémisphère Nord" /* (WGS 84)\\p32653"*/, 8, 104, 7, 135, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 53, Hémisphère Sud" /* (WGS 84)\\p32753"*/, 8, 104, 7, 135, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 54, Hémisphère Nord" /* (WGS 84)\\p32654"*/, 8, 104, 7, 141, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 54, Hémisphère Sud" /* (WGS 84)\\p32754"*/, 8, 104, 7, 141, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 55, Hémisphère Nord" /* (WGS 84)\\p32655"*/, 8, 104, 7, 147, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 55, Hémisphère Sud" /* (WGS 84)\\p32755"*/, 8, 104, 7, 147, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 56, Hémisphère Nord" /* (WGS 84)\\p32656"*/, 8, 104, 7, 153, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 56, Hémisphère Sud" /* (WGS 84)\\p32756"*/, 8, 104, 7, 153, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 57, Hémisphère Nord" /* (WGS 84)\\p32657"*/, 8, 104, 7, 159, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 57, Hémisphère Sud" /* (WGS 84)\\p32757"*/, 8, 104, 7, 159, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 58, Hémisphère Nord" /* (WGS 84)\\p32658"*/, 8, 104, 7, 165, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 58, Hémisphère Sud" /* (WGS 84)\\p32758"*/, 8, 104, 7, 165, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 59, Hémisphère Nord" /* (WGS 84)\\p32659"*/, 8, 104, 7, 171, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 59, Hémisphère Sud" /* (WGS 84)\\p32759"*/, 8, 104, 7, 171, 0, 0.9996, 500000, 10000000);
  _AddCurrentSysGeo(NULL, "UTM Zone 60, Hémisphère Nord" /* (WGS 84)\\p32660"*/, 8, 104, 7, 177, 0, 0.9996, 500000, 0);
  _AddCurrentSysGeo(NULL, "UTM Zone 60, Hémisphère Sud" /* (WGS 84)\\p32760"*/, 8, 104, 7, 177, 0, 0.9996, 500000, 10000000);
...
)
{
  ...
  *((hyper*) &mp_sSigProjCast.anUnitName[0]) = 0;
  ...
  // Sélectionne la famille en cours
...
)
{
  ...
  *((hyper*) &mp_sSigProjCast.anUnitName[0]) = 0; // Le casting qui TUE !!! Comment initialiser une chaine de 8 caractères à 0 :)
  ...
  { // Limitation du nombre de paramètres à prendre en compte pour la recherche CRC
    case 3 :
    case 7 :
    case 9 :
    case 19 :
