// SigPolygonPool.cpp: implementation of the CSigPolygonPool class.
//
//////////////////////////////////////////////////////////////////////

#include "stdafx.h"

#include "SigPolygonPool.h"
...
/*----------------------------------------------------------------------------*/
/*--- END FUNCTION HEADER ----------------------------------------------------*/
CSigPolygonPool::CSigPolygonPool
( const char* i_panStrName // = "CSigPolygonPool"
)
{
#ifdef _DEBUG
  SetClassName(i_panStrName); // Default object name

  _SetClassType("CSigPolygonPool");
#endif // _DEBUG

  mp_oasArraySigPolygon.CreateBuffer(sizeof(sSigPolygon),    64); // sSigPolygon
  mp_oasArraySigCache.CreateBuffer(sizeof(sSigPolygonCache), 64); // sSigPolygonCache
  mp_oasArraySigPoint.CreateBuffer(sizeof(sSigPoint),        64); // sSigPoint (12(16)/24(32) bytes)
} // OK
...
/*----------------------------------------------------------------------------*/
/*--- END FUNCTION HEADER ----------------------------------------------------*/
void CSigPolygonPool::SetClassName
( const char* i_panStrName
)
{
  mp_oStrObjectName = i_panStrName;

  mp_oasArraySigPolygon.SetClassName(mp_oStrObjectName+"::mp_oasArraySigPolygon");
  mp_oasArraySigCache.SetClassName(mp_oStrObjectName+"::mp_oasArraySigCache");
...
/*----------------------------------------------------------------------------*/
/*--- END FUNCTION HEADER ----------------------------------------------------*/
BOOL CSigPolygonPool::IsClosed
( int i_nPolygonIndex
)
{
  sSigPolygon* l_psSigPolygon;

  return
     ((l_psSigPolygon = mp_oasArraySigPolygon.GetSlotPointer(i_nPolygonIndex)) != NULL)
  && (
          *((sSigPoint*) mp_oasArraySigPoint[l_psSigPolygon->nStart])
       == *((sSigPoint*) mp_oasArraySigPoint[l_psSigPolygon->nStart + l_psSigPolygon->nIndex]);
     )
} // OK
...
)
{
  ...
  (
       ((l_psSigPolygon = mp_oasArraySigPolygon.GetSlotPointer(i_nPolygonIndex)) != NULL)
    && (IsClosed(i_nPolygonIndex) == FALSE)
  )
  {
    Add
    ( i_nPolygonIndex
    , mp_oasArraySigPoint[l_psSigPolygon->nStart]);
    );
  }
  else{}
} // OK
...
/*----------------------------------------------------------------------------*/
/*--- END FUNCTION HEADER ----------------------------------------------------*/
int CSigPolygonPool::GetSize
( int i_nPolygonIndex
)
{
  sSigPolygon* l_psSigPolygon = mp_oasArraySigPolygon.GetSlotPointer(i_nPolygonIndex);

  if(l_psSigPolygon != NULL)
  {
    return l_psSigPolygon->nSize;
  }
  else
  {
    return 0;
...
)
{
  ...
  (
       ((l_psSigPolygon = mp_oasArraySigPolygon.GetSlotPointer(i_nPolygonIndex)) != NULL)
    && (i_nPointNumber <= l_psSigPolygon->nSize)
    && (i_nPointNumber >  0)
  )
  {
    l_psSigPolygon->nIndex = i_nPointNumber - 1;

    return l_psSigPolygon->nIndex;
  }
  else
  {
    return -1;
...
)
{
  ...
  (
       ((l_psSigPolygon = mp_oasArraySigPolygon.GetSlotPointer(i_nPolygonIndex)) != NULL)
    && (l_psSigPolygon->nIndex < l_psSigPolygon->nSize)
  )
  {
    mp_oasArraySigPoint[l_psSigPolygon->nIndex++] = i_roSigPoint;
  }
  else{}
} // OK
...
/*----------------------------------------------------------------------------*/
/*--- END FUNCTION HEADER ----------------------------------------------------*/
void CSigPolygonPool::RemoveAll
( int i_nPolygonIndex
)
{
...
/*----------------------------------------------------------------------------*/
/*--- END FUNCTION HEADER ----------------------------------------------------*/
BOOL CSigPolygonPool::InSpanProper
( int i_nPolygonIndex
, int i_nSigPointStart
, int i_nSigPointEnd
, int i_nSigPointIndex
...
/*----------------------------------------------------------------------------*/
/*--- END FUNCTION HEADER ----------------------------------------------------*/
int CSigPolygonPool::PointSeparation
( int i_nPolygonIndex
, int i_nSigPointStart
, int i_nSigPointEnd
)
...
/*----------------------------------------------------------------------------*/
/*--- END FUNCTION HEADER ----------------------------------------------------*/
sSigPoint CSigPolygonPool::GetClosestPoint
( int        i_nPolygonIndex
, sSigPoint& i_roSigPoint
...
/*----------------------------------------------------------------------------*/
/*--- END FUNCTION HEADER ----------------------------------------------------*/
BOOL CSigPolygonPool::_Diagonalie
( int i_nPolygonIndex
, int i_nSigPointStart
, int i_nSigPointEnd
)
...
/*----------------------------------------------------------------------------*/
/*--- END FUNCTION HEADER ----------------------------------------------------*/
void CSigPolygonPool::Translate
( int        i_nPolygonIndex
...
/*----------------------------------------------------------------------------*/
/*--- END FUNCTION HEADER ----------------------------------------------------*/
void CSigPolygonPool::Rationalise
( int i_nPolygonIndex
, int i_nAngle
)
{
...
/*----------------------------------------------------------------------------*/
/*--- END FUNCTION HEADER ----------------------------------------------------*/
tREAL CSigPolygonPool::SegmentLength
( int i_nPolygonIndex
, int i_nSigPointStart
, int i_nSigPointEnd
)
...
/*----------------------------------------------------------------------------*/
/*--- END FUNCTION HEADER ----------------------------------------------------*/
sSigPoint CSigPolygonPool::Centroid
( int  i_nPolygonIndex
...
/*--- END FUNCTION HEADER ----------------------------------------------------*/
/*
BOOL CSigPolygonPool::GetAttributes
( tREAL     *o_pnArea
...
)
{
  ...
  *o_poSigPointCentre = sSigPoint( D2R(0.0), D2R(0.0), D2R(0.0) );
  ...
  CSigPolygonPool i_oSigPoint(nNumUniquePoints);  // Save current polygon
...
/*----------------------------------------------------------------------------*/
/*--- END FUNCTION HEADER ----------------------------------------------------*/
BOOL CSigPolygonPool::Intersected
( int        i_nPolygonIndex
...
/*----------------------------------------------------------------------------*/
/*--- END FUNCTION HEADER ----------------------------------------------------*/
BOOL CSigPolygonPool::IntersectedProp
( int        i_nPolygonIndex
, sSigPoint& i_roSigPointA
, sSigPoint& i_roSigPointB
)
...
/*----------------------------------------------------------------------------*/
/*--- END FUNCTION HEADER ----------------------------------------------------*/
BOOL CSigPolygonPool::Triangulate
( int              i_nPolygonIndex
, CSigPolygonPool* o_poSigPolygonTri
)
{
  int         l_nLoop;
  int         l_nSize = GetSize();
  ...
  CSigPolygonPool l_oSigPolyTempo = *this;
...
/*----------------------------------------------------------------------------*/
/*--- END FUNCTION HEADER ----------------------------------------------------*/
BOOL CSigPolygonPool::TriangCenter
( int              i_nPolygonIndex
, CSigPolygonPool* o_poSigPolygonTri
...
/*----------------------------------------------------------------------------*/
/*--- END FUNCTION HEADER ----------------------------------------------------*/
BOOL CSigPolygonPool::TriangDelauney
( int              i_nPolygonIndex
, CSigPolygonPool* o_poSigPolygonTri
)
{
...
/*----------------------------------------------------------------------------*/
/*--- END FUNCTION HEADER ----------------------------------------------------*/
void CSigPolygonPool::NaturalSpline
( int      i_nPolygonIndex
...
/*----------------------------------------------------------------------------*/
/*--- END FUNCTION HEADER ----------------------------------------------------*/
tREAL CSigPolygonPool::Curvature
( int i_nPolygonIndex
, int i_nSigPointIndex
)
{
...
)
{
  ...
  CSigPolygonPool XVals; // (nMaxPt - nMinPt + 1);
  CSigPolygonPool YVals; // (nMaxPt - nMinPt + 1);
...
/*----------------------------------------------------------------------------*/
/*--- END FUNCTION HEADER ----------------------------------------------------*/
int CSigPolygonPool::Simplify
( int              i_nPolygonIndex
, CSigPolygonPool* o_poSigPolygonSimple
, float            i_nTolerance
)
{
  int        l_nLoop;
...
/*----------------------------------------------------------------------------*/
/*--- END FUNCTION HEADER ----------------------------------------------------*/
void CSigPolygonPool::_SimplifyDP
( float            i_nTolerance
, CSigPolygonPool* i_poSigPolyVertex
, int              i_nIndexStart
, int              i_nIndexEnd
)
{
...
/*----------------------------------------------------------------------------*/
/*--- END FUNCTION HEADER ----------------------------------------------------*/
BOOL CSigPolygonPool::Clipping
( int              i_nPolygonIndex
, CSigPolygonPool* o_poSigPolygonSimple
, CSigPolygonPool& i_roSigPolygonSrc
, int              i_nClippingMode
)
{
/*
...
/*----------------------------------------------------------------------------*/
/*--- END FUNCTION HEADER ----------------------------------------------------*/
sSigPoint& CSigPolygonPool::operator[]
( int i_nPolygonIndex
, int i_nSigPointIndex
)
{
...
/*----------------------------------------------------------------------------*/
/*--- END FUNCTION HEADER ----------------------------------------------------*/
sSigPoint& CSigPolygonPool::Point
( int i_nPolygonIndex
, int i_nSigPointIndex
)
{
...
/*----------------------------------------------------------------------------*/
/*--- END FUNCTION HEADER ----------------------------------------------------*/
void CSigPolygonPool::operator=
( int              i_nPolygonIndex
, CSigPolygonPool& i_oSigPoint
)
{
  int l_nLoop;
  int l_nSize;
