...
void TiXmlBase::PutString( const TIXML_STRING& str, TIXML_STRING* outString )
{
	...
	while( i<(int)str.length() )
	{
		...
		if (    c == '&' 
// MODIF_KOCH 060727
// DK 060727 (IMPEXP GPX) : Correction d'un bug
//		     && i < ( (int)str.length() - 2 ) // Si on ajoute ça, on ne filtre QUE en fin de ligne
			 && str[i+1] == '#'
//			 && str[i+2] == 'x' // Si on ajoute ça, on ne filtre QUE les valeurs hexadécimales
// MODIF_KOCH 060727
       )
		{
